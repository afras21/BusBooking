        ...
        <Row><h3 style={{paddingBottom:"20px"}}>Frequently Asked Questions</h3>
           <Accordion>
                <AccordionItem>
                    ...
                    <AccordionItemBody>
                         <strong>How do I buy a ticket on Waybus.com ?</strong>
                        ...
                        <p>A copy of the ticket would have been sent to you by e-mail when you booked the ticket. Please take a printout of that mail and produce it at the time of boarding. If you have not received your ticket to the e-mail id you provided, you can take a printout on Waybus.com website by entering the PNR Number that was sent you by SMS while booking the ticket.</p>
                         <strong>Why is it mandatory to provide my mobile number during booking the ticket(s)?</strong>
                         <p>You must fill in the field "Mobile Number" when booking tickets. Your mobile number will be used to send Booking confirmation SMS, Boarding point details, bus operator will be able to contact you quickly in case you are not on time at the boarding point or Waybus will be able to contact you if there is any change in schedule. </p>
                ...
                <AccordionItem>
                    ...
                    <AccordionItemBody>
                     ...
                     <p>Partial Ticket Cancellation is accepted by few operators. Please check the cancellation terms of the bus operator provided while booking the ticket. Partial Cancellation of ticket is currently allowed through our portal. Please visit http://www.Waybus.com to cancel your tickets.</p>
                     </AccordionItemBody>
                </AccordionItem>
                <AccordionItem>
                    <AccordionItemTitle>
                    ...
                    <AccordionItemBody>
                        ...
                        <p> It depends on the bus operator you have booked your ticket with. Even mTickets are available on Way Bus. For operators that support mTickets, the SMS that is sent to your mobile can be produced at the time of boarding and you will be allowed to travel. </p>
                ...
                <AccordionItem>
                    ...
                    <AccordionItemBody>
                      ...
                      <p>WayBus provides a 100% refund if the bus is missed due to either waybus or its’ partner company's fault. However, if the bus is missed due to any other reason not directly related to Way Bus no refund is provided. </p>
                ...
                <AccordionItem>
                    ...
                    <AccordionItemBody>
                      ...
                      <p>If you have any additional questions, comments or other general customer service inquiries, please email us at support@Waybus.com or call us at +918130787891.</p>
                     </AccordionItemBody>
                </AccordionItem>
           </Accordion>
        </Row>
